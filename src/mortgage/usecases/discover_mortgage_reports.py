...
@dataclass
class DiscoverMortgageReportsRequest:
    ticker: str
    reference_date: datetime | None = None


@dataclass
class DiscoverMortgageReportsResponse:
    discovered: int
    submitted: int
    skipped: int


class DiscoverMortgageReportsUseCase:
    def __init__(
        self,
        funds_repository: FundsRepository,
        reports_repository: ReportsRepository,
        report_collector: ReportCollector,
        submit_analysis_usecase: SubmitMortgageAnalysisUseCase,
    ...
    async def execute(self, req: DiscoverMortgageReportsRequest) -> DiscoverMortgageReportsResponse:
        ...
        if not fund:
            ...
            logger.info("Auto-created mortgage fund %s", ticker)
        ...
        return DiscoverMortgageReportsResponse(
