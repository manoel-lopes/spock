...
from src.infra.adapters.analysis.ports.transparency_analyzer import (
    AnalysisResult,
...
class HeuristicTransparencyAnalyzer(TransparencyAnalyzer):
    def analyze(self, text: str) -> AnalysisResult:
        ...
        quality_score = total_score / len(METRICS)
