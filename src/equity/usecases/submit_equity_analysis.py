...
@dataclass
class SubmitEquityAnalysisRequest:
    ticker: str
    pdf_url: str
...
@dataclass
class SubmitEquityAnalysisResponse:
    job_id: str
    report_id: str


class SubmitEquityAnalysisUseCase:
    def __init__(
        self,
    ...
    async def execute(self, req: SubmitEquityAnalysisRequest) -> SubmitEquityAnalysisResponse:
        ...
        return SubmitEquityAnalysisResponse(job_id=external_job_id, report_id=report.id)
