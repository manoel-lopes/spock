...
@dataclass
class DiscoverEquityReportsRequest:
    ticker: str
    reference_date: datetime | None = None


@dataclass
class DiscoverEquityReportsResponse:
    discovered: int
    submitted: int
    skipped: int


class DiscoverEquityReportsUseCase:
    def __init__(
        self,
        funds_repository: FundsRepository,
        reports_repository: ReportsRepository,
        report_collector: ReportCollector,
        submit_analysis_usecase: SubmitEquityAnalysisUseCase,
    ...
    async def execute(self, req: DiscoverEquityReportsRequest) -> DiscoverEquityReportsResponse:
        ...
        if not fund:
            ...
            logger.info("Auto-created equity fund %s", ticker)
        ...
        return DiscoverEquityReportsResponse(
